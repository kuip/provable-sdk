...
class TestVerify:
    ...
    def test_verify_with_inclusion(self):
        ...
        kayros_hash = "22" * 32
        sibling_hash = "33" * 32
        root_hash = hashlib.sha3_256(bytes.fromhex(kayros_hash + sibling_hash)).hexdigest()
        ...
        with patch.object(verify_module, "get_record_by_hash") as mock_get_record, patch.object(
            ...
            assert result["valid"] is True
            assert result["details"]["levelsHashType"] == "sha3-256"
    ...
    def test_verify_with_inclusion_supports_sha256_override(self):
        data_item = "11" * 32
        kayros_hash = "22" * 32
        sibling_hash = "33" * 32
        ...
        with patch.object(verify_module, "get_record_by_hash") as mock_get_record, patch.object(
            verify_module, "compute_hash_from_hex"
        ) as mock_compute_hash, patch.object(verify_module, "get_merkle_proof") as mock_get_proof:
            mock_get_record.return_value = {
                "data_item": b64(data_item),
                "data_type": "proof_type",
                "hash_item": b64(kayros_hash),
